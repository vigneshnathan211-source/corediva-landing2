...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'IT, ERP & AI Solutions Company in the UK | Corediva',
    'description'      => $pageSeo['meta_description'] ?? 'Enterprise ERP, AI chatbots, cloud & cybersecurity for UK businesses. Making Tax Digital-ready invoicing, 4-hour response. Get a free technical assessment today.',
    'canonical'        => 'uk/',
    'hreflang_pattern' => '',
...
<?php
    // Exactly one H1 per page. The lead slide (UK-specific here, because
        ...
        <div class="custom-container">
            <div class="cd-about-grid">
                <div class="cd-about-copy">
                    ...
                    <h2 class="section-title">Headquartered in India.<br>Engineered for the UK.</h2>
                    <p>Corediva Tech Solutions has been building enterprise systems since
                       ...
                       WhatsApp automation, cloud infrastructure and cybersecurity. Our UK
                       representative coordinates delivery locally, while the engineering team
                       builds systems for UK businesses that need enterprise-grade work without
                       enterprise-grade overhead.</p>
                    <p>Invoicing and finance systems we build for UK clients are formatted for
                       HMRC's Making Tax Digital requirements from the start, not retrofitted
                       after the fact. Chatbots, CRM integrations and lead routing run on the
                       same WhatsApp-first workflow that keeps a response landing within hours,
                       not days.</p>
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i> Delivery hours aligned to GMT/BST</li>
                        <li><i class="las la-check-circle" aria-hidden="true"></i> Making Tax Digital-ready invoicing built in</li>
                    </ul>
    ...
    <section class="faq-area cd-faq" id="faq">
        <div class="custom-container">
            <div class="section-header text-center">
                ...
                <h2 class="section-title">Questions we get from the UK</h2>
            </div>
            ...
            <div class="custom-row justify-content-between align-items-center">
                <div class="left-content">
                    ...
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i>
                            Making Tax Digital-compliant invoicing, built in by default</li>
                    </ul>
                </div>
