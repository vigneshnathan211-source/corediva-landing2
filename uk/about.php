<?php
/**
 * Who We Are -- company/about page (United Kingdom).
 * URL: /uk/about/
 */
...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'Who We Are | Corediva Tech Solutions UK',
    'description'      => $pageSeo['meta_description'] ?? ('A decade-old, MSME & DUNS certified engineering team headquartered in '
                         . 'India, building Making Tax Digital-ready ERP, CRM, AI and cloud systems for UK businesses.'),
    'canonical'        => 'uk/about/',
            ...
            <div class="custom-container">
                <div class="hero-portfolio-body">
                    <div class="hero-section-content text-center">
                        ...
                        <h1 class="section-title">Enterprise engineering, built for how UK businesses buy.</h1>
                        <p>Corediva Tech Solutions is the team behind the ERP, CRM, AI automation
                           and cloud projects UK businesses run on, MSME and DUNS certified, and
            ...
            <div class="hero-service-about simple-shadow">
                <div class="section-header d-flex align-items-center justify-content-between w-full">
                    <div class="left">
                        ...
                        <p>An engineering team built for how UK businesses buy, backed by a decade
                ...
                <div class="hero-service-about-body">
                    <p>Corediva Tech Solutions has spent
                       ...
                       cloud infrastructure. We're headquartered in Tiruchirappalli, India, with a
                       representative here in the UK, plus a representative in the UAE, and clients
                       across Singapore, the US, Australia and beyond. For UK businesses, that
                       means a team that already builds invoicing formatted for HMRC's Making Tax
                       Digital requirements, not a freelancer figuring it out on your dime.</p>
