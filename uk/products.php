<?php
/**
 * Products -- products overview page (United Kingdom).
 * URL: /uk/products/
 */
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('Twelve products across scheduling, finance, CRM, ERP and automation, '
                         ...
                         . 'Solutions builds for UK businesses.'),
    'canonical'        => 'uk/products/',
...
?>
    ...
    <!-- Hero: same hero-service-wrap pattern as services.php, checklist
         ...
         time, Making Tax Digital-ready invoicing) since they apply to every
         page on this site, not just services. -->
                ...
                <div class="hero-service-about">
                    ...
                    <div class="hero-service-about-body">
                        ...
                        <ul>
                            ...
                            <li><i class="las la-check"></i> Making Tax Digital-ready invoicing built in</li>
                        </ul>
                    </div>
                </div>
            </div>
