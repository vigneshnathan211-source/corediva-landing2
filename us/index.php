...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'IT, ERP & AI Solutions Company in the USA | Corediva',
    'description'      => $pageSeo['meta_description'] ?? 'Enterprise ERP, AI chatbots, cloud & cybersecurity for US businesses. Sales-tax-ready invoicing, 4-hour response. Get a free technical assessment today.',
    'canonical'        => 'us/',
    'hreflang_pattern' => '',
...
<?php
    // Exactly one H1 per page. The lead slide (US-specific here, because
            ...
            <div class="cd-about-grid">
                <div class="cd-about-copy">
                    ...
                    <p>Corediva Tech Solutions has been building enterprise systems since
                       ...
                       workflow automation, cloud infrastructure and cybersecurity. Our engineering
                       team delivers systems for US businesses that need enterprise-grade work
                       without enterprise-grade overhead, with support scheduled to overlap every
                       US time zone.</p>
                    <p>Invoicing and finance systems we build for US clients itemize state and
                       local sales tax by line from the start, not retrofitted after the fact,
                       since there's no single national rate to design around. Chatbots, CRM
                       integrations and lead routing are built around whichever channel your
                       customers actually use, web, email, phone or WhatsApp.</p>
    ...
    <section class="faq-area cd-faq" id="faq">
        <div class="custom-container">
            <div class="section-header text-center">
                ...
                <h2 class="section-title">Questions we get from the US</h2>
            </div>
