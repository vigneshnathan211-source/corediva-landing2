<?php
/**
 * Partners -- alliances, tech stack and platform integrations (United States).
 * URL: /us/partners/
 *
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('The alliances, engineering stack and platform integrations behind '
                         . "Corediva Tech Solutions' delivery for US businesses."),
    'canonical'        => 'us/partners/',
                ...
                <div class="hero-service-about">
                    ...
                    <div class="hero-service-about-body">
                        ...
                        <ul>
                            ...
                            <li><i class="las la-check"></i> State and local sales-tax-ready invoicing</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="custom-row justify-content-between align-items-center">
                <div class="left-content">
                    ...
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i>
                            State and local sales tax itemized by line, built in by default</li>
                    </ul>
                </div>
