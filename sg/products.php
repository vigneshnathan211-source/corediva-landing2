<?php
/**
 * Products -- products overview page (Singapore).
 * URL: /sg/products/
 */
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('Twelve products across scheduling, finance, CRM, ERP and automation, '
                         ...
                         . 'Solutions builds for Singapore SMEs.'),
    'canonical'        => 'sg/products/',
...
?>
    ...
    <!-- Hero: same hero-service-wrap pattern as services.php, checklist
         ...
         time, PDPA) since they apply to every page on this site, not
         just services. -->
    ...
    <!-- Product catalogue: grouped by group_label, same card pattern the
         ...
         both use, now as real links since every product has a detail
         page. -->
...
<?php endforeach; ?>
    ...
    <!-- Consulting Excellence: same real copy as the homepage/services hub
         -- reused rather than rewritten, per the same reasoning
