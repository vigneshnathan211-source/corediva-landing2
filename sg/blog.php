...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'Blog | Corediva Tech Solutions Singapore',
...
?>
    ...
    <!-- Hero: same hero-service-wrap pattern as services.php/products.php. -->
