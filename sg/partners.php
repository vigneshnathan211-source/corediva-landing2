<?php
/**
 * Partners -- alliances, tech stack and platform integrations (Singapore).
 * URL: /sg/partners/
 *
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('The alliances, engineering stack and platform integrations behind '
                         . "Corediva Tech Solutions' delivery for Singapore SMEs."),
    'canonical'        => 'sg/partners/',
