...
/**
 * Service detail: Managed IT Services (Singapore)
 * URL: /sg/services/managed-it-services-singapore/
 */
...
$detailService = get_service('managed-it-services');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/services/managed-it-services-singapore/',
    'hreflang_pattern' => 'services/managed-it-services-{suffix}',
];
