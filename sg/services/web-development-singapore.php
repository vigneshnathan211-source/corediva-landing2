...
/**
 * Service detail: Web Development (Singapore)
 * URL: /sg/services/web-development-singapore/
 */
...
$detailService = get_service('web-development');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/services/web-development-singapore/',
    'hreflang_pattern' => 'services/web-development-{suffix}',
];
