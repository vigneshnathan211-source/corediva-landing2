...
/**
 * Service detail: Automation Solutions (Singapore)
 * URL: /sg/services/automation-singapore/
 */
...
$detailService = get_service('automation');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/services/automation-singapore/',
    'hreflang_pattern' => 'services/automation-{suffix}',
];
