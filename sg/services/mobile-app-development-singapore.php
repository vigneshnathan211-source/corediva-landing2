...
/**
 * Service detail: Mobile App Development (Singapore)
 * URL: /sg/services/mobile-app-development-singapore/
 */
...
$detailService = get_service('mobile-app-development');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/services/mobile-app-development-singapore/',
    'hreflang_pattern' => 'services/mobile-app-development-{suffix}',
];
