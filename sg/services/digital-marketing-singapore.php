...
/**
 * Service detail: Digital Marketing (SEO) (Singapore)
 * URL: /sg/services/digital-marketing-singapore/
 */
...
$detailService = get_service('digital-marketing');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/services/digital-marketing-singapore/',
    'hreflang_pattern' => 'services/digital-marketing-{suffix}',
];
