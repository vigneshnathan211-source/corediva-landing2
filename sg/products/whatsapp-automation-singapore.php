...
/**
 * Product detail: Web Automate / WhatsApp Automation (Singapore)
 * URL: /sg/products/whatsapp-automation-singapore/
 */
...
$product = get_product('whatsapp-automation');
if (!$product) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/products/whatsapp-automation-singapore/',
    'hreflang_pattern' => 'products/whatsapp-automation-{suffix}',
];
