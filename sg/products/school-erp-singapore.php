...
/**
 * Product detail: School Management ERP -- ScubaSchool (Singapore)
 * URL: /sg/products/school-erp-singapore/
 */
...
$product = get_product('school-erp');
if (!$product) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/products/school-erp-singapore/',
    'hreflang_pattern' => 'products/school-erp-{suffix}',
];
