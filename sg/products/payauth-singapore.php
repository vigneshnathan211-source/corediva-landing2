...
/**
 * Product detail: Payauth (Singapore)
 * URL: /sg/products/payauth-singapore/
 */
...
$seo = [
    ...
    'canonical'        => 'sg/products/payauth-singapore/',
    'hreflang_pattern' => 'products/payauth-{suffix}',
];
