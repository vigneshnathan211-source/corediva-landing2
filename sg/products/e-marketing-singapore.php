...
/**
 * Product detail: E-Marketing (Singapore)
 * URL: /sg/products/e-marketing-singapore/
 */
...
$product = get_product('e-marketing');
if (!$product) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'sg/products/e-marketing-singapore/',
    'hreflang_pattern' => 'products/e-marketing-{suffix}',
];
