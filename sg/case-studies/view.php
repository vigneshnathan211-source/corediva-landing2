<?php
/**
 * Case study detail (Singapore). One shared file serves every slug, same
 * reasoning as blog/post.php.
 * URL: /sg/case-studies/{slug}/  ->  /sg/case-studies/view.php?slug={slug}
 */
...
$seo = [
    ...
    'canonical'        => 'sg/case-studies/' . $case['slug'] . '/',
    'hreflang_pattern' => '',
];
...
render_schema_breadcrumbs([
    ...
    ($case['client_name'] ?: 'Case Study') => 'sg/case-studies/' . $case['slug'] . '/',
]);
