<?php
/**
 * Who We Are -- company/about page (Australia).
 * URL: /au/about/
 */
...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'Who We Are | Corediva Tech Solutions Australia',
    'description'      => $pageSeo['meta_description'] ?? ('A decade-old, MSME & DUNS certified engineering team headquartered in '
                         . 'India, building ABN/BAS-ready ERP, CRM, AI and cloud systems for Australian businesses.'),
    'canonical'        => 'au/about/',
            ...
            <div class="custom-container">
                <div class="hero-portfolio-body">
                    <div class="hero-section-content text-center">
                        ...
                        <h1 class="section-title">Enterprise engineering, built for how Australian businesses buy.</h1>
                        <p>Corediva Tech Solutions is the team behind the ERP, CRM, AI automation
                           and cloud projects Australian businesses run on, MSME and DUNS certified, and
            ...
            <div class="hero-service-about simple-shadow">
                <div class="section-header d-flex align-items-center justify-content-between w-full">
                    <div class="left">
                        ...
                        <p>An engineering team built for how Australian businesses buy, backed by a decade
                ...
                <div class="hero-service-about-body">
                    <p>Corediva Tech Solutions has spent
                       ...
                       representatives in the UAE and UK, and clients across Singapore, the US and
                       beyond. For Australian businesses, that means a team that already understands
                       ABN and BAS reporting requirements and builds around them, not a freelancer
