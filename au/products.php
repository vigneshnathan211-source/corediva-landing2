<?php
/**
 * Products -- products overview page (Australia).
 * URL: /au/products/
 */
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('Twelve products across scheduling, finance, CRM, ERP and automation, '
                         ...
                         . 'Solutions builds for Australian businesses.'),
    'canonical'        => 'au/products/',
...
?>
    ...
    <!-- Hero: same hero-service-wrap pattern as services.php, checklist
         ...
         time, ABN/BAS-ready invoicing) since they apply to every
                ...
                <div class="hero-service-about">
                    ...
                    <div class="hero-service-about-body">
                        ...
                        <ul>
                            ...
                            <li><i class="las la-check"></i> ABN/BAS-ready invoicing built in</li>
                        </ul>
                    </div>
                </div>
            </div>
