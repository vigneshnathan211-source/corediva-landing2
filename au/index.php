...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'IT, ERP & AI Solutions Company in Australia | Corediva',
    'description'      => $pageSeo['meta_description'] ?? 'Enterprise ERP, AI chatbots, cloud & cybersecurity for Australian businesses. ABN/BAS-ready invoicing, 4-hour response. Get a free technical assessment today.',
    'canonical'        => 'au/',
    'hreflang_pattern' => '',
...
<?php
    // Exactly one H1 per page. The lead slide (AU-specific here, because
        ...
        <div class="custom-container">
            <div class="cd-about-grid">
                <div class="cd-about-copy">
                    ...
                    <h2 class="section-title">Headquartered in India.<br>Engineered for Australia.</h2>
                    <p>Corediva Tech Solutions has been building enterprise systems since
                       ...
                       WhatsApp automation, cloud infrastructure and cybersecurity. We work
                       remotely with Australian businesses that need enterprise-grade systems
                       without the enterprise-grade overhead of a local integrator.</p>
                    <p>Invoicing and finance systems we build for Australian clients are structured
                       around ABN and BAS reporting from the start, not retrofitted after the fact.
                       Chatbots, CRM integrations and lead routing run on the same WhatsApp-first
                       workflow that keeps a response landing within hours, not days, whichever
                       timezone your team is calling from.</p>
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i> Delivery hours span AEST through AWST</li>
                        <li><i class="las la-check-circle" aria-hidden="true"></i> ABN/BAS-ready invoicing built in</li>
                    </ul>
    ...
    <section class="faq-area cd-faq" id="faq">
        <div class="custom-container">
            <div class="section-header text-center">
                ...
                <h2 class="section-title">Questions we get from Australia</h2>
            </div>
            ...
            <div class="custom-row justify-content-between align-items-center">
                <div class="left-content">
                    ...
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i>
                            ABN/BAS-ready invoicing, built in by default</li>
                    </ul>
                </div>
