...
/**
 * Service detail: Cloud Solutions (Australia)
 * URL: /au/services/cloud-solutions-australia/
 */
...
$detailService = get_service('cloud-solutions');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'au/services/cloud-solutions-australia/',
    'hreflang_pattern' => 'services/cloud-solutions-{suffix}',
];
