...
/**
 * Service detail: AI Solutions (Australia)
 * URL: /au/services/ai-solutions-australia/
 */
...
$detailService = get_service('ai-solutions');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'au/services/ai-solutions-australia/',
    'hreflang_pattern' => 'services/ai-solutions-{suffix}',
];
