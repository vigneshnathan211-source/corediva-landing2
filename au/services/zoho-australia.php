...
/**
 * Service detail: Zoho Infrastructure Setup (Australia)
 * URL: /au/services/zoho-australia/
 */
...
$detailService = get_service('zoho');
if (!$detailService) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'au/services/zoho-australia/',
    'hreflang_pattern' => 'services/zoho-{suffix}',
];
