...
/**
 * Product detail: Connect ERP (Australia)
 * URL: /au/products/connect-erp-australia/
 */
...
$product = get_product('connect-erp');
if (!$product) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'au/products/connect-erp-australia/',
    'hreflang_pattern' => 'products/connect-erp-{suffix}',
];
