...
/**
 * Product detail: Integrations on Web (IoW) (Australia)
 * URL: /au/products/web-integrations-australia/
 */
...
$product = get_product('web-integrations');
if (!$product) {
    http_response_code(404);
...
$seo = [
    ...
    'canonical'        => 'au/products/web-integrations-australia/',
    'hreflang_pattern' => 'products/web-integrations-{suffix}',
];
