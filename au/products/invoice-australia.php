...
/**
 * Product detail: Invoice (Australia)
 * URL: /au/products/invoice-australia/
 */
...
$seo = [
    ...
    'canonical'        => 'au/products/invoice-australia/',
    'hreflang_pattern' => 'products/invoice-{suffix}',
];
