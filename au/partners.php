<?php
/**
 * Partners -- alliances, tech stack and platform integrations (Australia).
 * URL: /au/partners/
 *
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('The alliances, engineering stack and platform integrations behind '
                         . "Corediva Tech Solutions' delivery for Australian businesses."),
    'canonical'        => 'au/partners/',
                ...
                <div class="hero-service-about">
                    ...
                    <div class="hero-service-about-body">
                        ...
                        <ul>
                            ...
                            <li><i class="las la-check"></i> ABN/BAS-ready invoicing</li>
                        </ul>
                    </div>
                </div>
            </div>
