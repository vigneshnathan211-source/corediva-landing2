<?php
/**
 * Products -- products overview page (United Arab Emirates).
 * URL: /ae/products/
 */
...
$seo = [
    ...
    'description'      => $pageSeo['meta_description'] ?? ('Twelve products across scheduling, finance, CRM, ERP and automation, '
                         ...
                         . 'Solutions builds for UAE businesses.'),
    'canonical'        => 'ae/products/',
...
?>
    ...
    <!-- Hero: same hero-service-wrap pattern as services.php, checklist
         ...
         time, VAT-ready invoicing) since they apply to every page on this
         site, not just services. -->
                ...
                <div class="hero-service-about">
                    ...
                    <div class="hero-service-about-body">
                        ...
                        <ul>
                            ...
                            <li><i class="las la-check"></i> FTA VAT-ready invoicing and e-invoicing support</li>
                        </ul>
                    </div>
                </div>
            </div>
