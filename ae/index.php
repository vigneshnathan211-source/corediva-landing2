<?php
/**
 * United Arab Emirates landing page.
 * URL: /ae/
 */
...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'IT, ERP & AI Solutions Company in UAE | Corediva',
    'description'      => $pageSeo['meta_description'] ?? 'Enterprise ERP, AI chatbots, cloud & cybersecurity for UAE businesses. VAT-ready invoicing, 4-hour response. Get a free technical assessment today.',
    'canonical'        => 'ae/',
    'hreflang_pattern' => '',
...
<?php
    // Exactly one H1 per page. The lead slide (UAE-specific here, because
        ...
        <div class="custom-container">
            <div class="cd-about-grid">
                <div class="cd-about-copy">
                    ...
                    <h2 class="section-title">Headquartered in India.<br>Engineered for the UAE.</h2>
                    <p>Corediva Tech Solutions has been building enterprise systems since
                       ...
                       WhatsApp automation, cloud infrastructure and cybersecurity. Our UAE
                       representative coordinates delivery locally, while the engineering team
                       builds systems for UAE businesses that need enterprise-grade work without
                       enterprise-grade overhead.</p>
                    <p>Invoicing and finance systems we build for UAE clients are designed with
                       FTA VAT and e-invoicing requirements in mind from the start, not retrofitted
                       after the fact. Chatbots, CRM integrations and lead routing are built around
                       the same WhatsApp-first workflow UAE businesses already use to talk to
                       customers.</p>
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i> Delivery hours aligned to Gulf Standard Time (UTC+4)</li>
                        <li><i class="las la-check-circle" aria-hidden="true"></i> FTA VAT-ready invoicing and e-invoicing support built in</li>
                    </ul>
...
<?php endforeach; ?>
    ...
    <section class="project-area" id="products">
        <div class="custom-container">
            ...
            <?php $groupKeys = array_keys($productGroups); ?>
            <div class="cd-tabs">
    ...
    <section class="faq-area cd-faq" id="faq">
        <div class="custom-container">
            <div class="section-header text-center">
                ...
                <h2 class="section-title">Questions we get from the UAE</h2>
            </div>
            ...
            <div class="custom-row justify-content-between align-items-center">
                <div class="left-content">
                    ...
                    <ul class="cd-about-points">
                        ...
                        <li><i class="las la-check-circle" aria-hidden="true"></i>
                            FTA VAT-compliant invoicing, built in by default</li>
                    </ul>
                </div>
