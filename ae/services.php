<?php
/**
 * What We Do -- services overview page (United Arab Emirates).
 * URL: /ae/services/
 */
...
?>
    ...
    <!-- Hero: on the theme's service.html hero. Checklist swapped for real
         commitments (credentials, response time, VAT-ready invoicing). -->
