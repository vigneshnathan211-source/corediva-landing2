<?php
/**
 * Who We Are -- company/about page (United Arab Emirates).
 * URL: /ae/about/
 */
...
$seo = [
    'title'            => $pageSeo['meta_title'] ?? 'Who We Are | Corediva Tech Solutions UAE',
    'description'      => $pageSeo['meta_description'] ?? ('A decade-old, MSME & DUNS certified engineering team headquartered in '
                         . 'India, building VAT-ready ERP, CRM, AI and cloud systems for UAE businesses.'),
    'canonical'        => 'ae/about/',
            ...
            <div class="custom-container">
                <div class="hero-portfolio-body">
                    <div class="hero-section-content text-center">
                        ...
                        <h1 class="section-title">Enterprise engineering, built for how UAE businesses buy.</h1>
                        <p>Corediva Tech Solutions is the team behind the ERP, CRM, AI automation
                           and cloud projects UAE businesses run on -- MSME and DUNS certified, and
            ...
            <div class="hero-service-about simple-shadow">
                <div class="section-header d-flex align-items-center justify-content-between w-full">
                    <div class="left">
                        ...
                        <p>An engineering team built for how UAE businesses buy, backed by a decade
                ...
                <div class="hero-service-about-body">
                    <p>Corediva Tech Solutions has spent
                       ...
                       representative here in the UAE, plus a representative in the UK, and clients
                       across Singapore, the US, Australia and beyond. For UAE businesses, that
                       means a team that already understands FTA VAT and e-invoicing requirements,
